...
const PUBLIC_ROUTES = ["/sign-in", "/sign-up", "/"]; // ДОДАНО КОРЕНЕВИЙ МАРШРУТ ДЛЯ ЗАПОБІГАННЯ ПЕТЛІ
...
export default function proxy(request: NextRequest) {
  ...
  // ПЕРЕВІРКА ДОСТУПУ НЕАВТОРІЗОВАНИХ КОРИСТУВАЧА ДО ПРИВАТНИХ СТОРІНОК
  ...
  // ПЕРЕВІРКА ДОСТУПУ АВТОРІЗОВАНИХ КОРИСТУВАЧІВ ДО ПУБЛІЧНИХ СТОРІНОК ВХОДУ
